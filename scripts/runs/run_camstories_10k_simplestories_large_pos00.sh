#!/bin/bash
#SBATCH --job-name=camstories_large_pos00
...
python train.py config/camstories_10k_simplestories_large.py \
  --posenc_type=sinusoidal --posenc_scale=0.0 \
  --out_dir=out/camstories_10k_simplestories/large_pos00 \
  --wandb_log=True --wandb_run_name=camstories-large-pos00
