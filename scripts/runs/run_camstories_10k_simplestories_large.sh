#!/bin/bash
#SBATCH --job-name=camstories_10k_simplestories_large
...
python train.py config/camstories_10k_simplestories_large.py --wandb_log=True --wandb_run_name=camstories-10k-simplestories-large-run3
