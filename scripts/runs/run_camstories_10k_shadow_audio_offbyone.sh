#!/bin/bash
#SBATCH --job-name=camstories_10k_shadow_audio_offbyone
...
python train.py config/camstories_10k_shadow_audio_offbyone.py --wandb_log=True --wandb_run_name=camstories-10k-shadow-audio-offbyone-run1
