#!/bin/bash
#SBATCH --job-name=camstories_10k_0padpe_medium
...
python train.py config/camstories_10k_0padpe.py --wandb_log=True --wandb_run_name=camstories-10k-0padpe-medium-run1
