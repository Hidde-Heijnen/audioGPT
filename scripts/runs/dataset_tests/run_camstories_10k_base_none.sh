#!/bin/bash
#SBATCH --job-name=cs_10k_base_none
...
python train.py config/dataset_tests/camstories_10k_base.py --wandb_log=True --wandb_run_name=cs-10k-base-none --posenc_type=none --out_dir=out/dataset_tests/camstories_10k_base_none
