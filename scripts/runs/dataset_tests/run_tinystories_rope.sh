...
python train.py config/dataset_tests/camstories_10k_base.py --wandb_log=True --wandb_run_name=tinystories-rope --dataset=tinystories/dataset_ss_tok --out_dir=out/dataset_tests/tinystories_rope
