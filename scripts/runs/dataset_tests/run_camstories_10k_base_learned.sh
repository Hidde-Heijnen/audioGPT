#!/bin/bash
#SBATCH --job-name=cs_10k_base_learned
...
python train.py config/dataset_tests/camstories_10k_base.py --wandb_log=True --wandb_run_name=cs-10k-base-learned --posenc_type=learned --out_dir=out/dataset_tests/camstories_10k_base_learned
