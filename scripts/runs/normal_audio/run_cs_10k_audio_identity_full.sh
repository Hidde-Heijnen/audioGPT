#!/bin/bash
#SBATCH --job-name=cs_10k_audio_identity_full
...
python train.py config/normal_audio/cs_10k_audio.py \
    --wandb_log=True \
    --wandb_run_name=cs-10k-normal-audio-identity-full \
    --out_dir=out/normal_audio/cs_10k_audio_identity_full \
