#!/bin/bash
#SBATCH --job-name=camstories_10k_simplestories_35M_frozen
...
python train.py config/camstories_10k_simplestories_35M_frozen.py --wandb_log=True --wandb_run_name=camstories-10k-simplestories-35M-frozen-run1
