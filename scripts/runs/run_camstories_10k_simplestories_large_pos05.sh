#!/bin/bash
#SBATCH --job-name=camstories_large_pos05
...
python train.py config/camstories_10k_simplestories_large.py \
  --posenc_type=sinusoidal --posenc_scale=0.5 \
  --out_dir=out/camstories_10k_simplestories/large_pos05 \
  --wandb_log=True --wandb_run_name=camstories-large-pos05
