#!/bin/bash
#SBATCH --job-name=camstories_large_pos01
...
python train.py config/camstories_10k_simplestories_large.py \
  --posenc_type=sinusoidal --posenc_scale=0.1 \
  --out_dir=out/camstories_10k_simplestories/large_pos01 \
  --wandb_log=True --wandb_run_name=camstories-large-pos01
