#!/bin/bash
#SBATCH --job-name=cs_10k_shadow_offbyone_none_unnorm
...
python train.py config/shadow_audio/cs_10k_shadow_offbyone.py \
    --wandb_log=True \
    --wandb_run_name=cs-10k-shadow-offbyone-none-unnorm \
    --out_dir=out/shadow_audio/cs_10k_shadow_offbyone_none_unnorm \
    --shadow_audio_residual=unnormalised_residual \
    --softmax_off_by_one=True \
    --shadow_auxiliary_loss=none
