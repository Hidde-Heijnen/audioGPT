#!/bin/bash
#SBATCH --job-name=cs_10k_shadow_offbyone
...
python train.py config/shadow_audio/cs_10k_shadow_offbyone.py --wandb_log=True --wandb_run_name=cs-10k-shadow-offbyone-target
