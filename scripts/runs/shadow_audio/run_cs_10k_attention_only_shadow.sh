#!/bin/bash
#SBATCH --job-name=cs_10k_attention_only_shadow
...
python train.py config/shadow_audio/cs_10k_attention_only_shadow.py --wandb_log=True --wandb_run_name=cs-10k-shadow-attention-only
