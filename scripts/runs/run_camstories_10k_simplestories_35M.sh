#!/bin/bash
#SBATCH --job-name=camstories_10k_simplestories_35M
...
python train.py config/camstories_10k_simplestories_35M.py --wandb_log=True --wandb_run_name=camstories-10k-simplestories-35M-run1
