# train an attention-only model with locked 4096-dimensional embeddings from parquet file

out_dir = 'out/normal_audio/cs_10k_attention_only'
...
# --- Transformer Type ---
transformer_type = 'attention_only'  # use attention-only transformer (no MLPs)
