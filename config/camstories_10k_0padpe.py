# train a medium-sized model for preprocessed stories with word-level tokenization and configurable positional encoding

out_dir = 'out/camstories_10k_0padpe/medium'
